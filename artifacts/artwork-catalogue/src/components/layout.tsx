  ...
  return (
    <>
      <SidebarHeader className="px-6 pt-7 pb-4">
        {/* Collection owner name — main identity, two lines */}
          ...
          <SidebarGroupContent>
            <SidebarMenu className="gap-2 px-4 py-4">
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
                  className="font-medium tracking-wide text-[13px] text-primary hover:text-primary hover:bg-primary/5"
                >
                  <Link
                    href="/artworks/new"
                    className="flex items-center gap-3 py-2"
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
                  className="font-medium tracking-wide text-[13px] text-muted-foreground hover:text-foreground"
                >
                  <Link
                    href="/batch-upload"
                    className="flex items-center gap-3 py-2"
      ...
      <SidebarFooter className="px-6 pb-6 pt-4">
        ...
        {/* Logo + Collection Tracker */}
        <Link href="/" onClick={closeIfNeeded}>
          <img
            src="/hourglass-logo.jpg"
            alt="Hourglass"
            className="w-full max-w-[112px] mb-3 object-contain"
          />
        </Link>
        <div className="leading-snug space-y-0.5">
          <p className="text-[11px] tracking-[0.18em] uppercase font-light text-muted-foreground">
            Collection
          </p>
          <p className="text-[11px] tracking-[0.18em] uppercase font-light text-muted-foreground">
            Tracker
      ...
      <div className="flex min-h-screen w-full bg-background text-foreground font-sans">
        ...
        <SidebarInset className="flex-1 flex flex-col min-w-0 overflow-hidden bg-background">
          <header className="h-14 border-b border-border/50 flex items-center px-6 lg:hidden">
            <SidebarTrigger />
            <span className="ml-4 text-sm tracking-widest uppercase text-muted-foreground font-light">
              Collection Tracker
            </span>
          </header>
