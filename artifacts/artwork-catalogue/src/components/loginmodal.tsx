      ...
      <div className="w-full max-w-sm px-8 py-10 space-y-8 border border-border bg-background shadow-lg">
        ...
        <div className="space-y-1 text-center">
          <img
            ...
            alt="Hourglass"
            className="w-28 mx-auto mb-6 object-contain"
          />
          {collectionOwner && (
            <p className="text-[13px] tracking-[0.15em] uppercase font-bold text-foreground">
              {collectionOwner}
            </p>
          )}
          <p className="text-[11px] tracking-[0.2em] uppercase font-light text-muted-foreground">
            Collection Tracker
          </p>
        </div>
